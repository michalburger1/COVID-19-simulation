...
countries = [
    ...
    Country('Italy', [ATG_formula(9.67, 30080, 5.26), ATG_formula(7.8, 4417)], 200),
    Country('USA', [ATG_formula(12.8, 1406000, 4.3), ATG_formula(10.2, 72329)], 1083),
    ...
    Country('Spain', [ATG_formula(6.4, 3665), ATG_formula(5.93, 1645, 6.54)], 155),
    Country('Germany', [ATG_formula(6.7, 3773), ATG_formula(5.99, 5086, 5.79)], 274),
